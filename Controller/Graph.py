...
class GraphCreatorClass:
    ...
    def scatter_diagram_creator(self, color_argument=None, point_size=1, marker='o',
    ...
    def bar_diagram_creator(self, argument):
        trout = self.dataframe[argument].value_counts().sort_index()
        trout_max = trout.max()
    ...
    def pie_chart_creator(self, column_y):
